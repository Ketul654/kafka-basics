...
public class KafkaDirectProducerApplication {
    private static Logger logger = LoggerFactory.getLogger(KafkaDirectProducerApplication.class);
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                */
                record = new ProducerRecord(KafkaConstants.MULTI_PARTITION_TOPIC_NAME, partitionId, Integer.toString(i), String.format("Message %d to direct partition %d:%s", i, partitionId, UUID.randomUUID().toString()));
